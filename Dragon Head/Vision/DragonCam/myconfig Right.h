...
#define CAM_NAME "Dragon Eye Right"
 ...
 */
#define MDNS_NAME "DragonEyeRight.local"
...
struct station stationList[] = {{"FIXME***","FIXMETOO***", true}};
 ...
 */
// #define URL_HOSTNAME "DragonEyeLeft.local"
